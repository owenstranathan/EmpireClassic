...
//
//  The display functions are responsible for nearly all graphical aspects of the game
//  all images in the game are drawing to an sfml RenderTexture which is then drawn to a render window
//  of sfml View
